<footer class="w-full px-4 py-4 lg:mt-72 mt-44">
    <div class="container mx-auto grid gap-4">
        <div class="flex flex-col gap-2 items-center">
            ...
            <div class="group mt-4 mb-6 flex items-center gap-2 text-base/50">
                <svg class="size-4 text-current" width="150" height="205" viewBox="0 0 150 205" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <p class="text-sm">
                    {{ __('Powered by') }} 
                    <a href="https://paymenter.org" target="_blank" class="underline hover:text-neutral-300">Paymenter</a> 
                    | Modified by 
                    <a href="https://billing.aeria.host" target="_blank" class="underline hover:text-neutral-300">Aeromenter</a>
                </p>
            </div>
        </div>
    </div>
